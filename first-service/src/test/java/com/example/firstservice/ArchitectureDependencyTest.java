...
public class ArchitectureDependencyTest {
    ...
    public void domain_dependent_test(){
        ArchRule rule = classes()
                ...
                .should().onlyHaveDependentClassesThat().resideInAnyPackage("..service..", "..repository..","..dto", "..domain");
    ...
    public void domain_no_dependency_test(){
        ArchRule rule = classes()
                .that().resideInAnyPackage("..domain")
                .should().onlyDependOnClassesThat().resideInAnyPackage("..domain","java..","jakarta..");
        rule.check(javaClasses);
    }
