...
import com.example.firstservice.model.FailedExamFixture;
import com.example.firstservice.model.PassedExamFixture;
...
public class StudentScoreServiceTest {
    ...
    void save_exam_failed_test() {
        //given
        StudentScoreEntity studentScore = StudentScoreData.failed()
                .exam("FINAL").build();
