...
public class StudentScoreServiceIntegrationTest extends IntegrationTest {
  ...
  void save_passed_student_score_test() {
    ...
    // then
    var passedStudentResponseList =
        studentScoreService.getPassedExamStudentsList(studentScore.getExam());
  ...
  void save_failed_student_score_test() {
    ...
    // then
    var failedStudentResponseList =
        studentScoreService.getFailedExamStudentsList(studentScore.getExam());
